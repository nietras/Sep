...
//namespace nietras.SeparatedValues.Internals;
//class SepLockFreeReaderHashSet
//{
//}

//// Inspired by LockFreeReaderHashtable and StringInternTable for native AOT in
//// .NET runtime repo.
//// https://github.com/dotnet/runtime/blob/main/src/coreclr/tools/Common/TypeSystem/Common/Utilities/LockFreeReaderHashtable.cs
//// https://github.com/dotnet/runtime/blob/main/src/coreclr/nativeaot/System.Private.CoreLib/src/System/String.Intern.cs
//// or look at concurrent dictionary
...
//class SepStringLockFreeReaderHashPool
//{
...
//    /// </summary>
//    private string? _entryInProcessOfWritingSentinel;
...
//    /// </summary>
//    private volatile Entry[] _hashtable = new Entry[_initialSize];
...
//    /// in progress.
//    /// </summary>
//    private volatile Entry[] _newHashTable;
...
//    /// </summary>
//    private Entry[] GetCurrentHashtable()
//    {
//        return _hashtable;
//    }
...
//    /// </summary>
//    private void SetCurrentHashtable(Entry[] hashtable)
//    {
...
//        unchecked
//        {
//            uint hash = unchecked(0xB1635D64) + key;
//            hash += (hash << 3);
//            hash ^= (hash >> 11);
//            hash += (hash << 15);
...
//    /// </summary>
//    public SepStringLockFreeReaderHashPool()
//    {
...
//    public bool TryGetValue(ReadOnlySpan<char> key, [NotNullWhen(true)] out string? value)
//    {
//        Entry[] hashTableLocal = GetCurrentHashtable();
//        Debug.Assert(hashTableLocal.Length > 0);
//        string? sentinel;
//        var mask = hashTableLocal.Length - 1;
//        var hashCode = GetKeyHashCode(key);
//        var tableIndex = HashInt1(hashCode) & mask;

//        Entry examineEntry = hashTableLocal[tableIndex];
//        if ((examineEntry.String == null) || (ReferenceEquals(examineEntry.String, _entryInProcessOfWritingSentinel)))
//        {
...
//        if (CompareKeyToValue(key, examineEntry.String))
//        {
//            value = examineEntry.String;
//            return true;
//        }

//        var hash2 = HashInt2(hashCode);
//        tableIndex = (tableIndex + hash2) & mask;
//        examineEntry = hashTableLocal[tableIndex];
//        while ((examineEntry.String != null) && (!ReferenceEquals(examineEntry.String, _entryInProcessOfWritingSentinel)))
//        {
//            if (CompareKeyToValue(key, examineEntry.String))
//            {
//                value = examineEntry.String;
...
//    string? WaitForSentinelInHashtableToDisappear(Entry[] hashtable, uint tableIndex)
//    {
//        var sentinel = Volatile.Read(ref _entryInProcessOfWritingSentinel);
//        if (sentinel == null)
//            return null;
...
//        while (true)
//        {
//            var value = Volatile.Read(ref hashtable[tableIndex].String);
//            if (value != sentinel)
//                return value;
//            sw.SpinOnce();
//        }
...
//    /// </summary>
//    private void Expand(Entry[] oldHashtable)
//    {
//        lock (this)
//        {
...
//            {
//                var value = oldHashtable[iEntry];
//                if (value.String == null)
//                    continue;

//                if ((value.String == sentinel) && (sentinel != null))
//                {
//                    // Entry is in the process of writing a value.
//                    value.String = WaitForSentinelInHashtableToDisappear(oldHashtable, iEntry);
...
//                if (newHashTable[tableIndex].String == null)
//                {
//                    // Add to hash
...
//                while (newHashTable[tableIndex].String != null)
//                {
//                    tableIndex = (tableIndex + hash2) & mask;
//                }
...
//    public string AddOrGetExisting(string value)
//    {
//        return AddOrGetExistingInner(value, out _);
//    }

//    private string AddOrGetExistingInner(string value, out bool addedValue)
//    {
...
//    string? VolatileReadNonSentinelFromHashtable(Entry[] hashTable, uint tableIndex)
//    {
//        var examineEntry = Volatile.Read(ref hashTable[tableIndex].String);
...
//    string TryAddOrGetExisting(string value, out bool addedValue)
//    {
...
//        Entry[] hashTableLocal = _hashtable;

//        addedValue = true;
//        uint mask = (uint)(hashTableLocal.Length - 1);
//        var hashCode = GetValueHashCode(value);
//        var tableIndex = HashInt1(hashCode) & mask;

//        // Find an empty spot, starting with the initial tableIndex
//        var examineEntry = VolatileReadNonSentinelFromHashtable(hashTableLocal, tableIndex);
...
//    private bool TryWriteSentinelToLocation(Entry[] hashTableLocal, uint tableIndex)
//    {
...
//        if (Interlocked.CompareExchange(ref hashTableLocal[tableIndex].String, _entryInProcessOfWritingSentinel, null) == null)
//        {
//            return true;
//        }
...
//    /// </summary>
//    private static void WriteValueToLocation(string value, Entry[] hashTableLocal, int tableIndex)
//    {
//        // Add to hash, use a volatile write to ensure that
//        // the contents of the value are fully published to all
//        // threads before adding to the hashtable
...
//    /// entry that can be in the table at this point
//    /// </summary>
//    private static void WriteAbortNullToLocation(Entry[] hashTableLocal, int tableIndex)
//    {
//        // Add to hash, use a volatile write to ensure that
//        // the contents of the value are fully published to all
//        // threads before adding to the hashtable
...
//    {
//        private Entry[] _hashtableContentsToEnumerate;
...
//    /// </summary>
//    static uint GetKeyHashCode(ReadOnlySpan<char> key) => SepHash.Default(key);
...
//    /// </summary>
//    static uint GetValueHashCode(Entry value) => value.HashCode;
//    static uint GetValueHashCode(string value) => SepHash.Default(value);

//    /// <summary>
//    /// Compare a key and value. If the key refers to this value, return true.
//    /// This function must be thread safe.
//    /// </summary>
//    static bool CompareKeyToValue(ReadOnlySpan<char> key, string value) => MemoryExtensions.SequenceEqual(key, value);

//    /// <summary>
//    /// Compare a value with another value. Return true if values are equal.
//    /// This function must be thread safe.
//    /// </summary>
//    static bool CompareValueToValue(string value1, string value2) => MemoryExtensions.SequenceEqual<char>(value1, value2);
...
//    /// </summary>
//    static string CreateValueFromKey(ReadOnlySpan<char> key) => new(key);
//}
...
//abstract class LockFreeReaderHashtable<TKey, TValue> where TValue : class
//{
//    private const int _initialSize = 16;
//    private const int _fillPercentageBeforeResize = 60;
...
//sealed class StringInternTable : LockFreeReaderHashtable<string, string>
//{
